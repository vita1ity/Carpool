...
@WebServlet("/route/unjoin/*")
public class UnjoinCarpoolServlet extends HttpServlet {
	
	private static final long serialVersionUID = -5767802537448824054L;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (pathInfo.length == 2) {
			...
			routeService.removePassenger(user.getUserId(), routeId);
